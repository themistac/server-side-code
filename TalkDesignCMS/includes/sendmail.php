...
$sendto = 'nicky@talkdesignandprint.com, alistair@talkdesignandprint.com';
//$sendto = 'marcus@talkdesignandprint.com';

//        The subject you'll see in your inbox
$subject = 'Quote request from Talk Design & Print website';

//        Message for the user when he/she doesn't fill in the form correctly.
$errormessage = '<h3 class="alert">Sorry, your message has not been sent. May we suggest...</h3>';
...
$alertmessage = "Make sure you aren't using any parenthesis or other characters like [][{}()*+\\^$|] in the message. Most URLS are fine though!";
...
$messagehtml = "<img src=\"http://www.talkdesignandprint.com/css/images/logo.png\">" .
$messagehtml . "<p>&nbsp;</p>\n" .
$messagehtml . "<table border=\"0\" cellpadding=\"5\" cellspacing=\"0\" style=\"border-bottom:5px solid #cccccc\">\n" .
$messagehtml . "<tr>\n".
...
$messagehtml .  "<br><p>&copy; " . date("Y") . " Talk Design &amp; Print</p>";

// To send HTML mail, the Content-type header must be set
$header = 'MIME-Version: 1.0' . "\r\n";
$header .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
$header .= 'From: info@talkdesignandprint.com';
